pipeline {
    agent any
     ...
     post{
        always {
             slackSend( channel: "#fundamentos-de-devops", color: "#00FFFF", messge: "Construyendo la aplicacion Sr. Alfredo Uzcategui: ${env.JOB_NAME} (<${env.BUILD_URL}|Open>)", iconEmoji: ":smile:")
        }
        success{
